    ...
    <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24 ">
            ...
            <div className="text-center xl:text-left order-2 xl:order-none">
                <span className="text-xl">Website Developer | UI UX Designer | Graphics Designer</span>
                <h1 className="h1 mb-6">
                    Hello I'm <br /> <span className="text-accent">Harvey Varela</span>
                </h1>
                <p className="max-w-[500px] mb-9 text-white/80">
                    Offering flexible and reliable services in front-end web development, graphic design (Canva,Figma,Adobe Photoshop,Adobe Illustrator & Adobe InDesign), 
                ...
                <div className="flex flex-col xl:flex-row items-center gap-8">
                    <a 
                        href="/harveyvarelaresumeupdated.pdf" 
                        download 
                        className="uppercase"
                    >
